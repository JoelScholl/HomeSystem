...
logging.debug("Shutdown Time is set to: "+shutdown_time)
logging.debug("Current time is: "+time.localtime()[3])
logging.debug("Time check is thus: "+time_chk)
logging.debug("Master Check is "+master_chk)
